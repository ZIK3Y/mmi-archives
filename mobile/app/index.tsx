    ...
    <SafeAreaView style={styles.safe}>
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.card}>
          <MenuItem icon="layers" label="Toutes les SAÉ" subtitle="Liste complète avec recherche" onPress={() => router.push('/sae')} />
          <View style={styles.separator} />
          <MenuItem icon="calendar" label="Par année" subtitle="MMI2 · MMI3" onPress={() => router.push('/sae/parAnnee')} />
          <View style={styles.separator} />
          <MenuItem icon="tag" label="Par domaine" subtitle="Web, Développement, DI, 3D, Création…" onPress={() => router.push('/sae/parDomaine')} />
        </View>
